...
public class StatsActivity extends AppCompatActivity
{
    ...
    class MyStats extends HTTPService
    {
        ...
        MyStats(Context context)
        {
            super(context);

            this.context = context;
            this.graphView = ((Activity) context).findViewById(R.id.grapViewStatistics);
        }
