...
public abstract class StatusDTO {
    private static final String TAG = "StatusDTO";
    private int userID;
    ...
    public StatusDTO(int userID, String userName, String dateToday, String updateKcalResult, String productID, String updateProductWeight, String productTimeStamp, String productWeight, String productName) {
        this.userID = userID;
